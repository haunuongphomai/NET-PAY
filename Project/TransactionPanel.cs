    ...
    public partial class TransactionPanel : UserControl
    {
        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand query3 = new SqlCommand("insert into history values (@phone1, getdate(), 'send', @username1, @receiver, @money, @phone2), " +
                    "(@phone2, getDate(), 'receive', @username1, @receiver, @money, @phone1)", clsDatabase.con);
